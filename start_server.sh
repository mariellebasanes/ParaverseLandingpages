...
echo "👉 http://localhost:8000/             (Paraverse Hub)"
echo "👉 http://localhost:8000/gco-connect/  (GCO Connect)"
echo "👉 http://localhost:8000/icare/        (iCare Support)"
echo "👉 http://localhost:8000/network-map/  (Network Map)"
echo "👉 http://localhost:8000/discourse-landing/ (Discourse)"
echo "👉 http://localhost:8000/flip-card/    (Flipcard Puzzle)"
echo "================================================="
