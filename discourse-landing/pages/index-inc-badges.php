...
<section id="badges" class="py-20 dc-bg-white" style="position: relative; overflow: hidden;">
  ...
  <div class="dl-bg-blob dl-blob-green" style="position: absolute; top: 5%; left: -10%; width: 450px; height: 450px; background: rgba(82,183,136,0.12); filter: blur(80px); pointer-events: none; z-index: 0;"></div>
  <div class="dl-bg-blob dl-blob-gold"  style="position: absolute; top: 35%; right: -12%; width: 500px; height: 500px; background: rgba(251,197,1,0.12); filter: blur(95px); pointer-events: none; z-index: 0;"></div>
        ...
        <div class="card card-bordered shadow-sm w-100 p-8 hover-elevate-up" style="border-radius:24px; background:#fff;">
          ...
          <div class="d-flex flex-column gap-6">
            ...
            <div class="d-flex align-items-center justify-content-between p-4 rounded-4" 
                 style="background: linear-gradient(135deg, #fffdf2 0%, #ffffff 100%); border: 1px solid rgba(251,197,1,0.25);">
              <div class="d-flex align-items-center gap-4">
                <!-- Avatar with rank crown badge -->
                <div class="position-relative">
                  <div class="rounded-circle p-1" style="background:linear-gradient(135deg,#fbc501,#e8b600); box-shadow: 0 2px 10px rgba(251,197,1,0.30);">
              ...
              <div class="text-end">
                <span class="badge badge-light-warning fs-8 fw-bolder px-3 py-2" style="background:rgba(251,197,1,0.12); color:#c89800 !important;">
                  4,850 pts
                </span>
              </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between p-4 rounded-4" 
                 style="background: linear-gradient(135deg, #fffbf7 0%, #ffffff 100%); border: 1px solid rgba(217,119,6,0.12);">
              <div class="d-flex align-items-center gap-4">
                <!-- Avatar with rank badge -->
                <div class="position-relative">
                  <div class="rounded-circle p-1" style="background:linear-gradient(135deg,#d97706,#b45309); box-shadow: 0 2px 8px rgba(217,119,6,0.15);">
                    <img src="/discourse-landing/assets/images/anonymous.png"
              ...
              <div class="text-end">
                <span class="badge badge-light-danger fs-8 fw-bolder px-3 py-2" style="background:rgba(217,119,6,0.08); color:#b45309 !important;">
                  2,540 pts
                </span>
              </div>
            </div>
      ...
      <div class="col-lg-6 d-flex">
        <div class="card card-bordered shadow-sm w-100 p-8 hover-elevate-up" style="border-radius:24px; background: linear-gradient(135deg, #ffffff 60%, #f7faf8 100%);">
          ...
          <div class="row g-4 mb-8">
            <div class="col-6">
              <div class="rounded-4 p-4 d-flex align-items-center gap-3" style="background:#f4faf6; border:1px solid rgba(45,106,79,0.08);">
          ...
          <div class="d-flex align-items-center justify-content-between mt-auto pt-4 border-top border-gray-100">
            <a href="#posts"
               ...
               style="background:var(--dc-green); border-color:var(--dc-green); color:#fff !important; font-size:0.85rem; box-shadow:0 4px 14px rgba(45,106,79,0.18); transition:all 0.2s;"
        ...
        <div class="card card-bordered shadow-sm p-8 hover-elevate-up" style="border-radius:24px; background: linear-gradient(135deg, #ffffff 70%, #fffdf4 100%);">
          ...
          <div class="d-flex align-items-center gap-3 mb-6">
            <div class="d-flex align-items-center justify-content-center rounded-3 flex-shrink-0"
                 style="width:36px; height:36px; background:rgba(45,106,79,0.10);">
              <i class="ki-outline ki-information-2 fs-3" style="color:#2D6A4F;"></i>
            </div>
          ...
          <div class="row g-6">
            ...
            <div class="col-md-4">
              <div class="d-flex align-items-start gap-4">
                <div class="d-flex align-items-center justify-content-center rounded-circle flex-shrink-0" 
                     style="width:40px; height:40px; background:#e6f5ee;">
                  <i class="ki-outline ki-shield-tick fs-4" style="color:#2D6A4F;"></i>
                </div>
                <div>
                  <h5 class="fw-bold text-gray-900 fs-6 mb-1">
                    Peer Solutions
                    <span class="badge badge-light-success fs-9 fw-bold ms-1" style="background:#e6f5ee; color:#2D6A4F !important;">+15 Rep</span>
                  </h5>
            ...
            <div class="col-md-4">
              <div class="d-flex align-items-start gap-4">
                <div class="d-flex align-items-center justify-content-center rounded-circle flex-shrink-0" 
                     style="width:40px; height:40px; background:rgba(251,197,1,0.13);">
                  <i class="ki-outline ki-crown fs-4" style="color:#c89800;"></i>
                </div>
                <div>
                  <h5 class="fw-bold text-gray-900 fs-6 mb-1">
                    Active Study Guilds
                    <span class="badge badge-light-warning fs-9 fw-bold ms-1" style="background:rgba(251,197,1,0.15); color:#d69e00 !important;">+50 Rep</span>
                  </h5>
                  <p class="text-gray-550 mb-0" style="font-size:0.8rem; line-height:1.5;">
