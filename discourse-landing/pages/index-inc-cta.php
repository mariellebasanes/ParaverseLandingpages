...
$app_url         = !empty($DISCOURSE_BASE) ? $DISCOURSE_BASE : "/discourse-landing/";
  ...
  <div class="container-xxl">
    <div class="text-center mx-auto position-relative" style="max-width:620px; z-index:2;">
      ...
      <p class="mb-10 dl-reveal dl-delay-2"
        ...
        Discourse connects thousands of FEU Tech, Alabang, and Diliman students every day. Enter the forum, find your community, and start the conversation now.
      </p>
