      ...
      <div class="col-lg-4 my-5">
        <div class="d-flex mb-5">
          <a href="https://feualabang.edu.ph/" target="_blank" class="me-1"><img class="h-50px lozad"
              data-src="/network-map/assets/img/logo/feu-alabang.webp"></a>
          <a href="https://feudiliman.edu.ph/" target="_blank" class="me-1"><img class="h-50px lozad"
              data-src="/network-map/assets/img/logo/feu-diliman.webp"></a>
          <a href="https://feutech.edu.ph/" target="_blank"><img class="h-50px lozad"
              data-src="/network-map/assets/img/logo/feu-tech.webp"></a>
        </div>
        <div class="d-flex">
          <a href="/" onclick="KTApp.showPageLoading()"><img data-src="/network-map/assets/img/logo.png"
...
<script src="/network-map/assets/plugins/global/plugins.bundle.js"></script>
<script src="/network-map/assets/js/scripts.bundle.v2.01.js"></script>
