...
<section class="section-padding about-section position-relative overflow-hidden" id="about" style="background: linear-gradient(135deg, #f8faff 0%, #eef2ff 100%);">
  ...
  <div class="container-xxl position-relative" style="z-index: 1;">
    <div class="row align-items-center g-0">
      <div class="col-lg-5 mb-8 mb-lg-0 z-index-2 pe-lg-15">
      ...
      <div class="col-lg-7">
        ...
        <div class="position-relative d-flex align-items-center justify-content-center" style="min-height: 380px;">
          <div class="horizontal-network-wrapper responsive-network-scale" style="height: 380px; width: 620px; min-width: 620px; margin: 0 auto; position: relative;">
            <!-- SVG Lines -->
            <svg class="horizontal-network-svg" width="100%" height="100%" style="position:absolute; top:0; left:0; z-index:0;">
              <!-- Col 1 to Col 2 (center single node) -->
              <path d="M 120,60 C 180,60 180,120 250,120" class="horizontal-net-line line-1" />
              <path d="M 120,180 C 180,180 180,120 250,120" class="horizontal-net-line line-2" />

              <!-- Col 2 (center) to Col 3 (two nodes on right) -->
              <path d="M 370,120 C 430,120 430,60 500,60" class="horizontal-net-line line-3" />
              <path d="M 370,120 C 430,120 430,180 500,180" class="horizontal-net-line line-4" />
            </svg>
            
            <!-- Nodes (Horizontal Cards) -->

            <!-- Col 1 (Left — two nodes) -->
            ...
            <!-- Col 2 (Center — single node, vertically centered) -->
            <div class="course-node n-3" style="top: 80px; left: 250px;">
            ...
            <!-- Col 3 (Right — two nodes) -->
            <div class="course-node n-4" style="top: 20px; left: 500px;">
            ...
            <div class="course-node n-5" style="top: 140px; left: 500px;">
          ...
          </div><!-- /horizontal-network-wrapper -->
...
<!-- Section 2: Duplicate with Map on Left, Text on Right -->
<section class="section-padding about-section position-relative overflow-hidden" id="about-2" style="background: #ffffff; border-top: 1px solid rgba(78, 127, 247, 0.05);">
  <!-- Advanced Decorative System -->
  <div class="position-absolute w-100 h-100 top-0 start-0 overflow-hidden" style="z-index: 0; pointer-events: none;">
    <!-- Tech Grid Overlay -->
    <div class="position-absolute top-0 start-0 w-100 h-100" 
    ...
    <!-- Large animated blobs -->
    <div class="position-absolute bg-primary rounded-circle blur-3 justify-content-center align-items-center animate-float"
      style="width: 35vw; height: 35vw; top: -10vw; right: -10vw; opacity: 0.08; filter: blur(80px); mix-blend-mode: multiply;">
    </div>
    <div class="position-absolute bg-info rounded-circle animate-float"
      style="width: 25vw; height: 25vw; bottom: -5vw; left: -5vw; opacity: 0.06; filter: blur(60px); animation-delay: -2s;">
    </div>
  </div>
  ...
  <div class="container-xxl position-relative" style="z-index: 1;">
    <div class="row align-items-center g-0">
      ...
      <div class="col-lg-7 order-2 order-lg-1">
        <div class="position-relative d-flex align-items-center justify-content-center" style="min-height: 380px;">
          <div class="horizontal-network-wrapper responsive-network-scale" style="height: 380px; width: 620px; min-width: 620px; margin: 0 auto; position: relative;">
            ...
            <!-- Col 1 (Left — two nodes) -->
            <div class="course-node n-1" style="top: 20px; left: 0;">
              <div class="course-card-mini m-0" data-bs-toggle="modal" data-bs-target="#course_details_modal" data-course-code="CCS0001" data-course-title="Computer Programming 1" data-course-lessons="Variables, Control Structures, Arrays, Functions" data-course-status="PASSED">
                <div class="course-type-bar type-ite">ITE</div>
                <div class="course-card-body">
            ...
            <div class="course-node n-2" style="top: 140px; left: 0;">
              <div class="course-card-mini m-0" data-bs-toggle="modal" data-bs-target="#course_details_modal" data-course-code="CCS0105" data-course-title="Discrete Mathematics" data-course-lessons="Set Theory, Logic, Graph Theory, Combinatorics" data-course-status="PASSED">
                <div class="course-type-bar type-ite">ITE</div>
                <div class="course-card-body">
            ...
            <!-- Col 2 (Center — single node, vertically centered) -->
            <div class="course-node n-3" style="top: 80px; left: 250px;">
              <div class="course-card-mini m-0" data-bs-toggle="modal" data-bs-target="#course_details_modal" data-course-code="CCS0021" data-course-title="Data Structures and Algorithms" data-course-lessons="Stacks, Queues, Binary Trees, Sorting Algorithms" data-course-status="PASSED">
                <div class="course-type-bar type-ite">ITE</div>
                <div class="course-card-body">
            ...
            <!-- Col 3 (Right — two nodes) -->
            <div class="course-node n-4" style="top: 20px; left: 500px;">
              <div class="course-card-mini m-0" data-bs-toggle="modal" data-bs-target="#course_details_modal" data-course-code="CS0048" data-course-title="Web Development" data-course-lessons="HTML, CSS, JavaScript, PHP, Responsive Design" data-course-status="PENDING">
                <div class="course-type-bar type-cs">CS</div>
                <div class="course-card-body">
            ...
            <div class="course-node n-5" style="top: 140px; left: 500px;">
              <div class="course-card-mini m-0" data-bs-toggle="modal" data-bs-target="#course_details_modal" data-course-code="CS0051" data-course-title="Artificial Intelligence" data-course-lessons="Machine Learning, Neural Networks, Search Algorithms" data-course-status="PENDING">
                <div class="course-type-bar type-cs">CS</div>
                <div class="course-card-body">
      ...
      <div class="col-lg-5 mb-8 mb-lg-0 z-index-2 ps-lg-15 order-1 order-lg-2">
        <div class="mb-8 position-relative">
            <!-- Decorative line accent -->
            <div class="position-absolute start-0 top-0 h-100 w-4px bg-primary rounded-pill opacity-10 ms-n8 d-none d-lg-block"></div>
            ...
            <h2 class="display-5 mb-8 text-dark fw-bolder">Unlock Advanced<br><span class="text-transparent bg-clip-text" style="background-image: linear-gradient(135deg, #4E7FF7 0%, #1c57cc 100%);">Subject Modules</span></h2>
        </div>
        <p class="mb-12 fs-5 text-gray-600 lh-lg">
          Never get caught off guard by sudden prerequisite requirements. See exactly how your core courses unlock key advanced modules like Web Development and AI.
        </p>
        <div class="d-flex align-items-center gap-6">
            <a href="#how-it-works" class="btn btn-nm-primary shadow-lg px-12 py-5 rounded-pill text-white transition-all hover-elevate-up">Explore Dependencies</a>
            <a href="#" class="text-primary fw-bold fs-7 text-decoration-none border-bottom border-primary border-opacity-20 pb-1 hover-translate-x-5 transition-all d-flex align-items-center gap-2">
              Learn More <i class="ki-duotone ki-arrow-right fs-5"></i>
            </a>
        </div>
