  ...
  <div class="container-xxl">
    ...
    <div class="row align-items-end mb-10">
      <div class="col-lg-7">
        ...
        <p class="text-gray-600 mb-0" style="font-size:1rem; line-height:1.72; max-width:480px;">
      ...
      <div class="col-lg-5 text-lg-end mt-6 mt-lg-0">
        <a href="/Discourse/communities/index.php"
           class="btn fw-bold rounded-pill px-7 py-3"
          ...
          <i class="bi bi-compass-fill me-2"></i>Explore Communities
        </a>
      </div>
    </div>
    ...
    <div class="row g-5">
      ...
      <div class="col-md-6 col-lg-4">
        <a href="/Discourse/communities/index.php?c=<?php echo $c['slug']; ?>"
          ...
          <div class="d-flex align-items-center gap-4 mb-4">
            ...
            <div>
              ...
              <span class="rounded-pill px-3 py-1 fw-semibold" style="font-size:0.72rem; background:<?php echo $c['badge_bg']; ?>; color:<?php echo $c['badge_c']; ?>;">
                <?php echo $c['members']; ?> members
              </span>
            </div>
          </div>

          <p class="text-gray-600 mb-0" style="font-size:0.85rem; line-height:1.65;">
            <?php echo htmlspecialchars($c['desc']); ?>
          </p>

          <div class="mt-4 d-flex align-items-center gap-1" style="color:var(--dc-green-light); font-size:0.82rem; font-weight:600;">
            View Community <i class="bi bi-arrow-right ms-1"></i>
          </div>
