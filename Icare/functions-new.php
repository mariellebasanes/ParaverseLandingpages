...
/** Stub when using local Icare: allow access; replace with real auth when using /sample/. */
if (!function_exists('IS_LOGGED_IN')) {
  function IS_LOGGED_IN($uri = '') {
    // Optional: redirect to login if not logged in, e.g.:
    // if (empty($_SESSION['loggedins'])) { header('Location: /login.php'); exit; }
  }
}
...
<meta name="description" content="' . (isset($META_DESC) ? htmlspecialchars($META_DESC, ENT_QUOTES, 'UTF-8') : '') . '">

<meta property="og:title" content="' . $META_TITLE . '" />
<meta property="og:url" content="' . $META_LINK . '" />
<meta property="og:image" content="' . $META_IMAGE . '" />
<meta property="og:description" content="' . (isset($META_DESC) ? htmlspecialchars($META_DESC, ENT_QUOTES, 'UTF-8') : '') . '">
<meta property="og:type" content="article" />
<meta property="og:locale" content="en_US" />
<meta property="og:site_name" content="Educational Innovation and Technology Hub" />

<meta name="twitter:title" content="' . $META_TITLE . '">
<meta name="twitter:description" content="' . (isset($META_DESC) ? htmlspecialchars($META_DESC, ENT_QUOTES, 'UTF-8') : '') . '">
<meta name="twitter:image" content="' . $META_IMAGE . '">
<meta name="twitter:card" content="summary_large_image">';
  $ASSETS_BASE = (defined('ICARE_BASE') && ICARE_BASE !== '') ? rtrim(ICARE_BASE, '/') : '';
  $A = $ASSETS_BASE !== '' ? $ASSETS_BASE . '/' : '/';
  echo '
<link rel="icon" type="image/x-icon" href="' . $A . 'assets/img/favicon.png">
<link rel="manifest" href="' . $A . 'assets/site.webmanifest?v=2">

<meta name="mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
<meta name="apple-mobile-web-app-title" content="iCare">
<link rel="apple-touch-icon" href="' . $A . 'assets/img/logo/icon-paraverse-192.png">

<link rel="stylesheet" href="' . $A . 'assets/plugins/global/plugins.bundle.css">
<link rel="stylesheet" href="' . $A . 'assets/css/style.keenicons.css">
<link rel="stylesheet" href="' . $A . 'assets/css/style.bundle.v2.full.css?version=1.1028">
<link rel="stylesheet" href="' . $A . 'assets/css/icare-landing.css">

<script src="' . $A . 'assets/js/jquery.js"></script>
